    ...
    public class DbInitializer
    {
        ...
        public async Task InitializeAsync()
        {
            ...
            try
            {
                ...
                {
                    _logger.LogWarning(ex, "Failed to connect to master database or create database {DbName}. " +
                        "This is common in cloud databases (e.g. Azure SQL / Aiven) where master database access is restricted. " +
                        "Attempting to proceed assuming the database already exists.", targetDatabaseName);
                }
